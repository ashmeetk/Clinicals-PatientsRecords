...
create table clinicaldata(
    ...
    primary key(id),
    constraint fk_pateint foreign key(patient_id) references patient(id)
);
...
insert into clinicaldata  values('100', '1', 'hw', '67/119', '2018-07-09 19:34:24');
insert into clinicaldata  values('101', '1', 'hw', '67/130', '2018-07-09 19:34:24');
insert into clinicaldata  values('102', '1', 'hw', '67/140', '2018-07-09 19:34:24');
insert into clinicaldata  values('103', '1', 'hw', '67/100', '2018-07-09 19:34:24');


select * from patient;

select * from clinicalData where patient_id=13;
